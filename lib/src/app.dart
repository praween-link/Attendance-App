      ...
      builder: (BuildContext context, Widget? child) {
        return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider<LectureController>(
              create: (context) => LectureController(),
            ),
          ...
          child: MaterialApp(
            ...
            onGenerateRoute: (RouteSettings routeSettings) {
              Routes route = Routes();
              return route.myMaterialPageRoute(
                  routeSettings, settingsController);
            },
          ),
        );
      },
