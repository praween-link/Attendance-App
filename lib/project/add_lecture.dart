          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 5.0),
                TextFormField(
                  onChanged: (value) => setState(() => column = int.parse(value)),
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(
                      ...
                      AwesomeDialog(
                        ...
                        btnOkOnPress: () {
                          ...
                          lectureController.addNewLecture(
                              ...
                              row: row,
                              column: column,
                              startDate: '${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}');
                          AttendanceSheetApi.insertDate(context, '${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}', row, column);
